...
$alternate = mysql_query("SELECT name FROM tbl_users WHERE position='".$s['position']."' AND sector='".$s['sector']."'") or die(mysql_error());
            ...
            <form role="form-horizontal" method="post" class="update-delegate">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <select class="form-control selectpicker" data-live-search="true" name="delegate_name" id="delegate_name" required>
              ...
              <div class="box-footer text-center">
                <button type="button" class="btn btn-primary" id="up_delegate"><i class="fa fa-paper-plane"></i> Process</button>
              </div>
            </form>
          </div>
          <!-- /.box -->
