<?php
    ...
    $alternate = mysql_query("SELECT * FROM tbl_users WHERE position='Supervisor (Support Function)' OR position='CS&Q Engineer' OR position='CS&Q Manager' AND sector='".$s['sector']."'") or die(mysql_error());
                    ...
                    <div class="box-body">
                        <div class="col-md-10">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" rows="4" name="comment" minlength=15 id="comment" required <?php if($tes['finance_mgrStatus'] == 'Approved' || $tes['eng_status'] == '' || $tes['spv_status'] == '' || $tes['mgr_status'] == ''){echo 'readonly';}?>><?php echo $tes['mgr_com']; ?></textarea>
                          </div>
                      </div>
                    </div>
