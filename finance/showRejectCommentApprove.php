                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <div class="col-md-8">
                            ...
                            <textarea class="form-control" rows="4" name="comment" minlength="10" id="comment" minlength=15 required <?php if($tes['finance_mgrStatus'] == 'Approved' || $tes['eng_status'] == '' || $tes['spv_status'] == ''|| $tes['mgr_status'] == ''){echo 'readonly';}?>><?php echo $tes['mgr_com']; ?></textarea>
                        </div>
                    </div>
