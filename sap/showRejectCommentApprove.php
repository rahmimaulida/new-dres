                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <div class="col-md-8">
                            ...
                            <textarea class="form-control" rows="4" name="comment" minlength="10" id="comment" minlength=15 required <?php if($tes['mgr_status'] == 'Approved' || $tes['eng_status'] == '' || $tes['spv_status'] == ''){echo 'readonly';}?>><?php echo $tes['mgr_com']; ?></textarea>
                        </div>
                    </div>
