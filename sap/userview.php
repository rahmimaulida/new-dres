            ...
            <div class="form-group">
                <label for="Line" class="col-sm-2 control-label">Line</label>
                  <div class="col-sm-10">
                    ...
                    <input type="checkbox" name="line[]" value="<?php echo $resss['line']; ?>"> &nbsp;<?php echo $resss['line']; ?><br>
                      <?php } ?>
...
<!--
<div class="modal fade" id="ModalLine" tabindex="-1" role="dialog" aria-labelledby="memberModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header box-solid bg-green">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title" id="memberModalLabel">Add Line</h4>
            </div>
            <div>
