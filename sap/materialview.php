...
if (isset($_POST['submit'])) {
  ...
  $price=$_POST['price'];
  $uom=$_POST['uom'];
  $qry= "INSERT INTO tbl_material VALUES('','$material_name','$material_description','$product_family','$price', $uom)";
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <form method="post" action="export.php">
              <button type="submit" class="btn btn-warning btn-sm" name="export">
              <span class="	glyphicon glyphicon-download-alt"></span> Download Data
            </button>

              <!--<a class="btn btn-warning pull-right" href="export.php" name="export"><i class="fa fa-download"></i> Download Data</a>
        ...
        <div class="modal-content">
            ...
            <form role="form" class="form-horizontal" action="materialadd_proc.php" method="post">
              <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="price" class="col-sm-2 control-label">Unit of Material</label>

                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="uom" id="uom" placeholder="Insert UOM" required>
                    </div>
                </div>
              </div>
