  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Action Tracker</li>
      </ol>
    </section>
        ...
        <div class="col-md-6">
          <div class="box box-solid box-success">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-bar-chart"></i> Action Tracker By Month</h3>
            </div>
            <div class="box-body">
              <div id="act_month" style="width: 98%"></div>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="box box-solid box-success">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-bar-chart"></i> Action Tracker By Sector</h3>
            </div>
            <div class="box-body" height="50%">
              <div id="act_sector" style="width: 98%"></div>
            </div>
          </div>
        </div>
      </div>
...
$(function () {
    $('#act_month').highcharts({
        chart: {
            height: 450,
            type: 'column'
        },
        title: {
            text: "Action Tracker By Monthly",
            x: -20 //center
        },
        subtitle: {
            text: '2018',
