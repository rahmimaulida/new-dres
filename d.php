...
$tbltemp = mysql_query("SELECT id_reject, material_name, qty, plant, sector, line, issue,
           amount, action, status, pic, insertedBy, gambar FROM tempreject_".$_SESSION['username']."");
